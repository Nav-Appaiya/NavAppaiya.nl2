...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NavCMSBundle:User')->findAll();

        return $this->render('NavCMSBundle:User:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('NavCMSBundle:User:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NavCMSBundle:User')->find($id);
        ...
        return $this->render('NavCMSBundle:User:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('NavCMSBundle:User:edit.html.twig', array(
            'entity'      => $entity,
