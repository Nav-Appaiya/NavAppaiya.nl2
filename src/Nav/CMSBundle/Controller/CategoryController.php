...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NavCMSBundle:Category')->findAll();

        return $this->render('NavCMSBundle:Category:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('NavCMSBundle:Category:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NavCMSBundle:Category')->find($id);
        ...
        return $this->render('NavCMSBundle:Category:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('NavCMSBundle:Category:edit.html.twig', array(
            'entity'      => $entity,
